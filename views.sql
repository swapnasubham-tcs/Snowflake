...
CREATE OR REPLACE TABLE COMPANY.HR.countries 
    ( country_id          CHAR(2) not null PRIMARY KEY       
    , country_name        VARCHAR(255) 
    , region_id           NUMBER  REFERENCES regions(region_id)
    ); 

CREATE OR REPLACE TABLE COMPANY.HR.locations
...
CREATE OR REPLACE TABLE COMPANY.HR.departments
...
CREATE OR REPLACE TABLE COMPANY.HR.jobs
...
ALTER TABLE COMPANY.HR.DEPARTMENTS ADD CONSTRAINT dept_mgr_fk
    FOREIGN KEY (manager_id)
    REFERENCES employees (employee_id);

CREATE OR REPLACE TABLE COMPANY.HR.job_history
...
FROM
    COMPANY.HR.EMPLOYEES E
    LEFT JOIN COMPANY.HR.DEPARTMENTS D ON E.DEPARTMENT_ID = D.DEPARTMENT_ID
WHERE
    D.DEPARTMENT_ID = 80;

-- Creating IT Department View (Normal View)--

CREATE OR REPLACE VIEW COMPANY.HR.IT_DEPARTMENT
    AS
    (
        SELECT 
            E.EMPLOYEE_ID                            AS EMPLOYEE_ID,
...
GRANT USAGE ON DATABASE COMPANY TO ROLE USERADMIN;
GRANT USAGE ON SCHEMA HR TO ROLE USERADMIN;
GRANT SELECT ON VIEW COMPANY.HR.IT_DEPARTMENT TO ROLE USERADMIN;

-- Normal View (Check with UserAdmin Role)--
SELECT * FROM COMPANY.HR.IT_DEPARTMENT;

-- View defination is visible --
SHOW VIEWS LIKE 'IT%' IN COMPANY.HR;
...
SELECT 
    ...
    VIEW_DEFINITION
FROM 
    COMPANY.INFORMATION_SCHEMA.VIEWS
WHERE
    TABLE_NAME = 'IT_DEPARTMENT';
...
-- Creating IT Department View (Normal View)--
CREATE OR REPLACE VIEW COMPANY.HR.SALES_DEPARTMENT
    AS
    (
        SELECT 
            E.EMPLOYEE_ID                            AS EMPLOYEE_ID,
...
GRANT USAGE ON DATABASE COMPANY TO ROLE USERADMIN;
GRANT USAGE ON SCHEMA HR TO ROLE USERADMIN;
GRANT SELECT ON VIEW COMPANY.HR.SALES_DEPARTMENT TO ROLE USERADMIN;

-- Normal View (Check with UserAdmin Role)--
SELECT * FROM COMPANY.HR.SALES_DEPARTMENT;
...
FROM 
    COMPANY.INFORMATION_SCHEMA.VIEWS
WHERE
    TABLE_NAME = 'SALES_DEPARTMENT';

-- Normal View --
SELECT * FROM COMPANY.HR.SALES_DEPARTMENT;

-- View defination is visible --
SHOW VIEWS LIKE 'SALES%' IN COMPANY.HR;

-- Secure View --

-- Select IT Department With Salary--
SELECT 
    E.EMPLOYEE_ID                            AS EMPLOYEE_ID,
    E.FIRST_NAME                             AS FIRST_NAME,
    E.LAST_NAME                              AS LAST_NAME,
...
-- Creating IT Department View (Secure View)--
CREATE OR REPLACE SECURE VIEW COMPANY.HR.IT_DEPARTMENT_SALARY
    AS
    (
        SELECT 
            E.EMPLOYEE_ID                            AS EMPLOYEE_ID,
...
GRANT USAGE ON DATABASE COMPANY TO ROLE USERADMIN;
GRANT USAGE ON SCHEMA HR TO ROLE USERADMIN;
GRANT SELECT ON VIEW COMPANY.HR.IT_DEPARTMENT_SALARY TO ROLE USERADMIN;

-- Normal View (Check with UserAdmin Role)--
-- Testing IT_DEPARTMENT_SALARY --
SELECT * FROM COMPANY.HR.IT_DEPARTMENT_SALARY;
...
FROM 
    COMPANY.INFORMATION_SCHEMA.VIEWS
WHERE
    TABLE_NAME = 'IT_DEPARTMENT_SALARY';

-- View defination is not visible --
SHOW VIEWS LIKE 'IT%' IN COMPANY.HR;
...
FROM
    COMPANY.HR.EMPLOYEES E
WHERE
    E.DEPARTMENT_ID IN (60,80);

-- Creating MVIEW --
CREATE OR REPLACE MATERIALIZED VIEW COMPANY.HR.IT_SALES
    AS
    (
        SELECT 
            E.EMPLOYEE_ID                            AS EMPLOYEE_ID,
...
INSERT INTO employees VALUES 
        ...
        , 'ANIKDAS'
        , '590.423.8907'
        , TO_DATE('25-NOV-1993', 'dd-MON-yyyy')
        , 'IT_PROG'
        , 4900
        , NULL
        , 103
...
INSERT INTO employees VALUES 
        ...
        , 'SOMDUTTADE'
        , '590.423.7797'
        , TO_DATE('02-AUG-1993', 'dd-MON-yyyy')
        , 'IT_PROG'
        , 5100
        , NULL
        , 103
